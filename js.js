    ...
    content: `
                  <div class="licenses-wrapper">
                    <div class="licenses__settings">
                      <p class="licenses__settings--item1">Тариф доступен всем пользователям</p>
                      <span class="vertical-line licenses__settings--item2"></span>
                      ...
                      <span class="vertical-line licenses__settings--item4"></span>
                      <p class="licenses__settings--item5">Бесплатно за всех пользователей</p>
                    </div>
                    ...
                    <div class="item__main__content" >
                      ...
                      <div>
                        <span class="green_text"> Можно интегрировать с: </span>
                        Google Docs, Office 365, Microsoft Office , Telegram, VK
                      </div>
                    </div>
                    <div class="item__main__content" id="licenses-functions">
                      <p>Внутренний ИИ </p>
                      <p>
                      ...
                      <p>
                        ...
                        коммуникаций. <br />
                        <span
                          >Отсутствует возможность “Важных сообщений” и
                          генерации опросов</span
                        >
                      </p>
                      <p>
                        Внутренний мессенджер - с функциями WhatsApp <br />
                        <span
                      ...
                      <p>
                        ...
                        единую систему управления. <br />
                        <span>Невозможно подключить электронную почту</span>
                      </p>
                      <p>
                        Конструктор сайтов с бесплатным хостингом <br />
                        <span> Число опубликованных сайтов - 1</span>
                      </p>
                      <p>
                        База знаний компании <br />
                        <span
                      ...
                      <p>
                        Каталог товаров <br />
                        <span
                          >Максимум 100 товаров могут быть опубликованы на
                          лендингах</span
                        >
                      </p>
                      <p>
                        Автоматизация продаж через CRM <br />
                        <span>Количество доступных воронок - 1</span> <br />
                        <span>Максимальное количество роботов - 5</span>
                      </p>
                      <p>
                        Чек-ин на работе с геопозицией <br />
                        <span
                          >Отсутствие учета рабочего времени сотрудников</span
                        >
                        <br />
                        <span>Отсутствие запуска рабочего дня</span>
                      </p>
                      <p>
                        Работа с виртуальными задачами <br />
                        <span>Отсутствует чек-лист в задачах</span> <br />
                        <span
                          >Невозможно назначить наблюдателя и
                          соисполнителя</span
                        >
                        <br />
                        <span>Невозможно генерировать под-задачи</span>
                      </p>
                    </div>
                  </div>
                  <br />
...
content: `
                  <div class="licenses-wrapper">
                    <div class="licenses__settings">
                      <p class="licenses__settings--item1">До 5 человек</p>
                      <span class="vertical-line licenses__settings--item2"></span>
                      <p class="licenses__settings--item3">
                        Диск 24 ГБ
                        <span class="little-text">
                      ...
                      <span class="vertical-line licenses__settings--item4"></span>
                      <p class="licenses__settings--item5">9&nbsp;600₸/мес</p>
                    </div>
                    <h3>Кому подойдет такой тариф?</h3>
                    <div class="item__main__content" >
                      <p>Стартапам</p>
                      ...
                      <div>
                        <span class="green_text"> Можно интегрировать с: </span>
                        Google Docs, Office 365, Microsoft Office , Telegram, VK, Телефония, WhatsApp, E-mail ( 1 ящик )
                      </div>
                    </div>
                    <div class="item__main__content" id="licenses-functions">
                      <p>Внутренний ИИ </p>
